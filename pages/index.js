...
const Page = () => {
  return (
    ...
    >
      ...
      >
        <Grid
          templateColumns={{ base: '1fr', md: '1fr 1fr' }} // Одна колонка на маленьких экранах, две колонки на больших
          gap={6}
          alignItems="center"
        >
          <Box>
            ...
            <Text fontSize="15px" fontFamily="'Montserrat', sans-serif" mb={4}>
              ...
              der Einführung eines betrieblichen Eingliederungsmanagementes oder
      ...
      >
        ...
        >
          ...
          kümmern, ist wie ein Handwerker, der keine Zeit hat, sein Werkzeug zu
          pflegen.
        </Text>
        <Text
          fontFamily="'Montserrat', sans-serif"
      ...
      <Container
        ...
        p={0}
        display="flex"
        h={{ base: '694.7px', sm: '526.1px', md: '436.1px', lg: '586.1px' }} // Фиксируем высоту контейнера (можно изменить по необходимости)
        position="relative"
      >
        <Box
          display="flex"
          ...
          >
            ...
            <Box>
              ...
              >
                ...
                Betriebsärzten und Fachkräften für Arbeitssicherheit unabhängig
                von der Unternehmensgröße. Wir helfen Ihnen dabei, die
                gesetzlichen Anforderungen nachvollziehbar und transparent
                umzusetzen und erbringen arbeitsmedizinische
                Vorsorgeuntersuchungen. Gerne beraten wir Sie darüber hinaus bei
